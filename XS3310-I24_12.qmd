...
Para un espacio paramétrico $\Omega$, dividido en dos subconjuntos disjuntos $\Omega_0$ y $\Omega_1$, de un parámetro $\theta$, se define la probabilidad de cometer el *error tipo I*, denotada como $\alpha(\delta)$ como: 
